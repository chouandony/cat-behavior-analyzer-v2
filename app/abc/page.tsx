      ...
      {step === 0 && (
        <div className="space-y-4">
          ...
          <div className="grid gap-2">
            {behaviors.map(b => (
              <label key={b.id} className="flex items-center gap-3 p-3 bg-white rounded-lg border border-earth-200 cursor-pointer hover:border-cat-300 transition-colors">
                <input
                  type="checkbox"
                  className="w-5 h-5 accent-cat-500 shrink-0"
