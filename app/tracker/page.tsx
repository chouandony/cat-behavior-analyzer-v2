...
const STORAGE_KEY = 'cat-behavior-tracker-v1'
...
export default function TrackerPage() {
  ...
  const addRecord = () => {
    ...
    setForm({ behaviorId: 'toileting', customName: '', date: getTodayString(), count: 1, intensity: 3, recovery: 5, note: '' })
    setShowForm(false)
    setError('')
  }
        ...
        <div className="flex flex-wrap gap-1.5">
          <button
            ...
            className={
              ...
              (activeFilter === 'all'
                ? 'bg-cat-500 text-white'
                : 'bg-white border border-earth-200 text-earth-500 hover:border-cat-300')
            }
          >
            全部
          </button>
      ...
      {stats && (
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white rounded-xl border border-earth-200 p-3 text-center">
            ...
            <p className="text-xl font-bold text-cat-600">{stats.totalCount}</p>
          </div>
          <div className="bg-white rounded-xl border border-earth-200 p-3 text-center">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1 text-sm bg-cat-500 hover:bg-cat-600 text-white px-3 py-1.5 rounded-lg transition-colors"
          >
            <Plus size={16} />
            新增
          </button>
          ...
          <div className="bg-white rounded-xl border border-earth-200 p-4 space-y-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2.5 rounded-lg border border-earth-200 text-sm focus:outline-none focus:border-cat-400 bg-white"
              >
                {behaviors.map(b => (
            ...
            {isCustom && (
              <div>
                ...
                <input
                  ...
                  placeholder="例如：追蟲、對吸塵器反應..."
                  className="w-full px-3 py-2 rounded-lg border border-earth-200 text-sm focus:outline-none focus:border-cat-400"
                />
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full accent-cat-500"
                />
