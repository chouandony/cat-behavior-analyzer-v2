        ...
        {Array.from({ length: totalSteps }).map((_, i) => (
          <div key={i} className="flex items-center flex-1 last:flex-none">
            <div
              className={cn(
                ...
                i < currentStep
                  ...
                  : i === currentStep
                  ? 'bg-cat-500 text-white ring-4 ring-cat-100'
            ...
            >
              ...
              {i === currentStep && (
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-cat-400 rounded-full animate-pulse" />
              )}
            </div>
            {i < totalSteps - 1 && (
              <div
        ...
        {labels.map((label, i) => (
          <span
            ...
            className={cn(
              ...
              i === currentStep ? 'text-cat-600 font-bold' : ''
            )}
          >
            {label}
          </span>
