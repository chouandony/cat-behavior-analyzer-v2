...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-cat-50/90 backdrop-blur-md border-b border-earth-200">
      <div className="max-w-2xl mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          <Link href="/" className="flex items-center gap-2 font-bold text-forest-600">
            <span className="text-xl">🐈</span>
            <span className="text-sm">貓咪行為分析</span>
          </Link>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'bg-cat-100 text-cat-700 font-medium'
      ...
      {open && (
        <div className="md:hidden border-t border-earth-200 bg-cat-50">
